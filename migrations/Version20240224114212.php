 ...
 */
final class Version20240224114212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, num BIGINT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, dateexp DATE NOT NULL, cvv INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
